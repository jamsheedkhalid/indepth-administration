...
function initGrades(grade) {
    ...
    httpGrade.open("GET", "/mysql/exam-center/term-reports/initGrades.php", false);
    httpGrade.send();
...
function fillSections(section, grade) {
    ...
    httpSection.open("GET", "/mysql/exam-center/term-reports/fillSections.php?grade=" + selected_grade, false);
    httpSection.send();
...
function fillTerms() {
    ...
    httpTerm.open("GET", "/mysql/exam-center/term-reports/fillTerms.php?student=" + selected_student, false);
    httpTerm.send();
...
function fillTermsSectionWise(gradeId, id, termId, type) {
    ...
    httpTerm.open("GET", "/mysql/exam-center/term-reports/fillTerms_SectionWise.php?section=" + section + "&type=" + type + "&grade=" + grade, false);
    httpTerm.send();
