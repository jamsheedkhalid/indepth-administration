            ...
            <div class="app-main__inner">
                <div class="app-page-title">
                    ...
                    <div class="row" style="margin-top: 10px">
                        <div class="col-md-12">
                            <div class="main-card mb-3 card">
                                <div class="card-header">REPORT CARDS
                                    <div class="btn-actions-pane-right">
                                    </div>
                                </div>
                                <div style="padding: 10px" class="row" id="student_report_cards">
                                </div>
                        ...
                        <div class="col-md-12">
                            <div class="main-card mb-3 card">
                                <div class="card-header">ASSIGNMENTS
                                    <div class="btn-actions-pane-right"><a href="/modules/academics/assignment/student_assignment.php">View Detailed</a>
                                    </div>
                                </div>
                                <div style="padding: 10px" class="row" id="student_statistics">
                                </div>
