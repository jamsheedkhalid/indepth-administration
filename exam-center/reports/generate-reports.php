                ...
                <div class="app-page-title">
                    <div class="page-title-wrapper">
                        <div class="page-title-heading">
                            ...
                            <div>GENERATE REPORT CARD
                                <div class="page-title-subheading">Generate and print report card for students
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="card-body">
                                        <form class="">
                                            ...
                                            <div class="position-relative form-group"><label for="studentSelect" class="">Student</label>
                                                <select name="studentSelect" id="studentSelect" class="form-control-sm form-control">
                                                    <option default>Select Student</option>
                                                </select></div>
                                            <div class="position-relative form-group"><label for="termSelect" class="">Term</label>
                                                <select name="termSelect" id="termSelect" class="form-control-sm form-control">
                                                    <option default>Select Student</option>
                                                </select></div>


                                            <button class="mt-1 btn btn-primary">Generate</button>
                                        </form>
                                    </div>
                                </div>
                            </div>
