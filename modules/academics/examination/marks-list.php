                ...
                <div class="app-page-title">
                    <div class="page-title-wrapper">
                        <div class="page-title-heading">
                            ...
                            <div>MARKS LIST
                                <div class="page-title-subheading">Final Term Mark
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="position-relative form-group col-sm-3"><label
                                            ...
                                            <select multiple="multiple"
                                                    onchange="fillSubjects('gradeSelect','sectionSelect','subject');getAnalysis()"
                                                    name="sectionSelect[]"
                                        ...
                                        <div class="col-sm">
                                            ...
                                            <div class="row" style="padding-left: 20px;">
                                                <div class="position-relative col-sm-3">
                                                    <label class="form-check-label"><input onchange="getAnalysis();"
                                                                                           type="checkbox"
                                                                                           id="show_ar_names"
                                                                                           name="show_ar_names"
