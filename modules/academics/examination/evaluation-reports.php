        ...
        <div class="app-main__inner">
                ...
                <div class="page-title-wrapper">
                    <div class="page-title-heading">
                        ...
                        <div>CLASS EVALUATION REPORTS
                            <div class="page-title-subheading">Generate and class evaluation report cards for students
                            </div>
                        </div>
                    </div>
            ...
            <div class="tab-content">
                ...
                <div class="tab-pane tabs-animation fade" id="tab-content-1" role="tabpanel">
                    <div>
                        <form  target="_blank" method="post" class="row"
                              action="/mysql/exam-center/evaluation-reports/generate_pdf.php">
                            <div class="col-md-6">
                                <div class="main-card mb-3 card">
                                    <div class="card-body">
                ...
                <div class="tab-pane tabs-animation fade" id="tab-content-2" role="tabpanel">
                    <div>
                        <form  target="_blank"  method="post" class="row"
                              action="/mysql/exam-center/evaluation-reports/generate_pdf_grade_wise.php">
                            <div class="col-md-6">
                                <div class="main-card mb-3 card">
                                    <div class="card-body">
...
<script> document.getElementById('liEvaluation_ReportCard').classList.add("mm-active")</script>
<script type="text/javascript" src="/js/evaluation_reports.js"></script>
