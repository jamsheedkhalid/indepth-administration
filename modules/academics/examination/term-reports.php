                        ...
                        <div>
                            <form target="_blank" method="post" class="row">
                                            ...
                                            <div>
                                                <div class="row">
                                                    ...
                                                    <div class="position-relative form-group col-sm"><label
                                                        ...
                                                        <select onchange="initialize_hidden_input('sectionSelect','hidden_section_studentWise');fillStudents();fillTerms();"
                                                                name="sectionSelect"
                                                                id="sectionSelect"
                                                ...
                                                <div class="position-relative form-group"><label for="studentSelect"
                                                                                                 class="">Student</label>
                                                    <select onchange="initialize_hidden_input('studentSelect','hidden_student_studentWise');fillTerms();"
                                                            name="studentSelect" id="studentSelect"
                                                            class="form-control-sm form-control">
                                                ...
                                                <div class="position-relative form-group"><label for="termSelect"
                                                    ...
                                                    <select name="termSelect" id="termSelect"
                                                            onchange="initialize_hidden_input('termSelect','hidden_term_studentWise');"
                                                            class="form-control-sm form-control">
                                                ...
                                                <button formaction="/mysql/exam-center/term-only-reports/generate_pdf_student_wise.php"
                                                        class="mt-1 btn btn-success" name="studentSubmitTerm"
                                                        type="submit">
                                                    Generate Term Report
                                                </button>


                                                <button formaction="/mysql/exam-center/term-reports/generate_pdf_student_wise.php"
                                                        class="mt-1 btn btn-success" name="studentSubmit" type="submit">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="main-card mb-3 card">
                                        <div class="card-body"><h5>Attendance Settings</h5>
                                            <div class="row">
...
<!--                                            </div>-->
                                            <div class="row">
                                                <div class="position-relative form-group col-sm">
                                                    <label>Start</label>
                                                    <input type="date" name="start_date" id="start_date" value="2020-09-01"/>
                                                </div>
                                                <div class="position-relative form-group col-sm">
                                                    <label>End</label>
                                ...
                                <div class="col-md-6">
                                    <div class="main-card mb-3 card">
                                        <div class="card-body">
                                            ...
                                            <div class="row">
                                                <div class="position-relative form-group col-sm ">
                                                    ...
                                                    <select name="sectionTermSelect" id="sectionTermSelect"
                                                            onchange="initialize_hidden_input('sectionTermSelect','hidden_term');"
                                                            class="form-control-sm form-control">
                                                        <option>Select Term</option>
                                                    </select>
                                            ...
                                            <button type="submit"
                                                    formaction="/mysql/exam-center/term-only-reports/generate_pdf.php"
                                                    name="sectionSubmitTerm" class="mt-1 btn btn-success ">
                                                Generate Term Report
                                            </button>

                                            <button type="submit"
                                                    formaction="/mysql/exam-center/term-reports/generate_pdf.php"
                                                    name="sectionSubmit" class="mt-1 btn btn-success ">
                                                Generate Complete Report
                                            </button>
                                ...
                                <div class="col-md-6">
                                    <div class="main-card mb-3 card">
                                        <div class="card-body">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="position-relative form-group col-sm ">
                                                    ...
                                                    <select name="gradeTermSelect" id="gradeTermSelect"
                                                            onchange="initialize_hidden_input('gradeTermSelect','hidden_term_gradeWise');"
                                                            class="form-control-sm form-control">
                                                        <option>Select Term</option>
                                                    </select>
                                            ...
                                            <button type="submit"
                                                    formaction="/mysql/exam-center/term-only-reports/generate_pdf_grade_wise.php"
                                                    name="submitGradeWiseTerm" class="mt-1 btn btn-success">
                                                Generate Term Report
                                            </button>
                                            <button type="submit"
                                                    formaction="/mysql/exam-center/term-reports/generate_pdf_grade_wise.php"
