...
// Page footer
    ...
    $pdf->Ln(8);
    $pdf->MultiCell(0, 10, "This is to certify that $ms $employee_name, $employee_nationality nationality, holder of passsport number $employee_passport is currently employed full time at Al Sanawbar School as $employee_jobTitle since $employee_joinDate till date.", 0, 'L', false);
    $pdf->Ln(6);
    $pdf->MultiCell(0, 10, "This letter has been given upon $hs request without any responsiblity from our part.", 0, 'L', false);
    $pdf->Ln(15);
